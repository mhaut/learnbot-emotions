...
class Face():
    def __init__(self):
        ...
        self.r_eye = Eye()
        self.eyelids = None
        self.l_eyebrow = EyeBrow()
        self.r_eyeBrow = EyeBrow()
        self.mouth = Mouth()

    def set_l_eye(self, l_eye):
        self.l_eye = l_eye

    def set_r_eye(self, r_eye):
        self.r_eye = r_eye

    def set_eyelids(self, lu_eyeLid, ld_eyeLid, ru_eyeLid, rd_eyeLid):
        self.eyelids = [lu_eyeLid, ld_eyeLid, ru_eyeLid, rd_eyeLid]

    def set_l_eyebrow(self, l_eyebrow):
        self.l_eyebrow = l_eyebrow

    def set_r_eyebrow(self, r_eyebrow):
        self.r_eyebrow = r_eyebrow
    ...
    def get_l_eyebrow(self):
        return self.l_eyebrow

    def get_r_eyebrow(self):
        return self.r_eyebrow
